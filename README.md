...
Сами файлы изображений загрузил на свой Яндекс.Диск и в JSON-файле базы данных прописал их ссылки (из-за этого есть небольшая задержка при переключении
изображений);