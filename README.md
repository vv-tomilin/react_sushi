...
* __Commit 40.5__ - наполнил компонент _AboutWebSitePage_ контентом и прописал для него стили;

* __Commit 40.6__ - наполнил компонент _DeliveryInfoPage_ контентом и прописал для него стили. Так же поправил найденные ошибки в стилях других компонентов;

* __Commit 41__ - добавил дополнительную информацию в "поп-ап" окне с составом продукта и стилизовал ее, сделал отображение выбранной категории в компоненте _SelectedCategory_, поправил обнаруженные ошибки в стилях в некоторых компонентах, так же исправил ошибки связанные с валидностью верстки компонентов;

* __Commit 41.1__ - изменил ссылки на фото с продуктами;

* __Commit 41.2__ - Сделал отображение количества одного продукта в корзину на кнопке "Хочу" в карточке продукта. Добавил отображение количества роллов в одной карточке продукта;

* __Commit 42__ - сделал небольшую оптимизацию приложения с помощью ***React.useCallback()*** и ***React.memo()***;


!!! ====================================== !!!


&#128073; <<<===== Дата публикации: 06.07.2021 (19:00 по московскому времени)
