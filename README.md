...
В модальном окне при нажатии на кнопку "Отлично!" или на крестик закрытия модального окна происходит очистка списка продуктов в корзине, закрытие модального окна и перенаправление на
главную страницу;